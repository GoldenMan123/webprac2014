...
ALTER TABLE COURSE ADD CONSTRAINT FK_COURSE_COMPANY FOREIGN KEY (company_id) REFERENCES COMPANY(company_id) ON DELETE CASCADE;
...
ALTER TABLE STUDENT_COURSE ADD CONSTRAINT FK_STUDENT_COURSE_STUDENT FOREIGN KEY (student_id) REFERENCES STUDENT(student_id) ON DELETE CASCADE;
...
ALTER TABLE LESSON ADD CONSTRAINT FK_LESSON_TEACHER FOREIGN KEY (teacher_id) REFERENCES TEACHER(teacher_id) ON DELETE CASCADE;